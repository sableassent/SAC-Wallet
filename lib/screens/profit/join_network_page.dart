            ...
            child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 20),
                  Text("Non-Profit Enrollment", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold)),
                  SizedBox(height: 20),
                  Container(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text("Name of Organization:", style: TextStyle(color: Colors.black87, fontSize: 15)),
                        Container(
                          width: screenWidth * 0.5,
                          padding: EdgeInsets.only(top: 10),
                          child: TextField(
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              ...
                              onChanged: (newValue) {
                                setState(() {
                                  locationIndex = locationList.indexOf(newValue);
                                });
                              },
                            ),
                          ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text("Status:", style: TextStyle(color: Colors.black87, fontSize: 15)),
                        Container(
