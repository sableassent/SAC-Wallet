                            ...
                            switch (snapshot.connectionState) {
                              ...
                              case ConnectionState.done:
                                ...
                                return Container(
                                  padding: EdgeInsets.all(0),
                                  child: Container(
                                      child: Text("${FlutterMoneyFormatter(amount: BigInt.parse(snapshot.data.substring(0,6)).toDouble()).output.symbolOnLeft}", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white),)),
                                );
                            }
                            return null;
                          }),
