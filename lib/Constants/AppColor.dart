...
class AppColor{
  ...
  static final List<Color> PRIMARY_GRADIENT = [Color(0xFF00c6ff), Color(0xFF0072ff)];

  static final List<Color> BACKGROUND_MAIN_GRADIENT = [Color(0xFF141E30), Color(0xFF243B55)];
